...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $.fn.callUpdate = function (Id) {
            ...
            $.module.load('Impianti/Operators/hs_Spl_Update');
        }

        $.fn.callconfig = function (Id) {
            localStorage.setItem("SplId", Id);
            $.module.load('Impianti/Operators/hs_Spl_Config');
        }

        $.fn.log = function (Cod) {
            localStorage.setItem("SplCod", Cod);
            $.module.load('Impianti/Operators/hs_Spl_log');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.callReplacements = function (Id) {
            ...
            $.module.load('Impianti/Operators/hs_Spl_Replacements');
        }
        /*----------------------------------------------------------------------*/
