/*
Impianti Operators Manage Heating System SDIN sensor cymt200 Add
------------------------------------------*/
$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#btnAdd').on('click', function (e) {
            ...
            if (chkAdd(hsId, Cod, sn, Descr) == true) {
                var req = $.DataAccess.cymt200_Add(hsId, Cod, Descr, sn, UserName, marcamodello, installationDate, NoteInterne);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
