...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $.fn.received_hs_Cidrm_setValue = function (hsId, Cod) {
            if (localStorage.getItem("hsId") == hsId) {
        ...
        $.fn.callUpdateCir = function (CirId) {
            ...
            $.module.load('Impianti/Operators/hs_Cirdm_Update');
        }

        $.fn.callconfigCir = function (CirId) {
            localStorage.setItem("CirId", CirId);
            $.module.load('Impianti/Operators/hs_Cirdm_Config');
        }

        $.fn.logCir = function (Cod) {
            localStorage.setItem("CirCod", Cod);
            $.module.load('Impianti/Operators/hs_Cirdm_log');
        }
        ...
        $.fn.callReplacements = function (Id) {
            ...
            $.module.load('Impianti/Operators/hs_Cirdm_Replacements');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.callChangeCurrentProfile = function (Id) {
            ...
            $.module.load('Impianti/Operators/ChangeCirdmCurrentProfile');
        }
        /**/
