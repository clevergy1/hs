/*
Impianti Operators Manage Heating System Boiler Add
------------------------------------------*/
$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#btnAdd').on('click', function (e) {
            ...
            if (chkAdd(hsId, CalCod, CalDescr) == true) {
                var req = $.DataAccess.hs_Cal_Add(hsId, CalCod, CalDescr, NoteInterne, UserName, marcamodello, installationDate);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
        ...
        function chkAdd(hsId, CalCod, CalDescr) {
            var retVal = false;
