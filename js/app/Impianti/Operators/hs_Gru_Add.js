...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#btnAdd').on('click', function (e) {
            ...
            if (chkAdd(hsId, GruCod, Descr) == true) {               
                var req = $.DataAccess.hs_Gru_Add(hsId, GruCod, Descr, NoteInterne, UserName, marcamodello, installationDate);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
        ...
        function chkAdd(hsId, GruCod, Descr) {
            var retVal = false;
