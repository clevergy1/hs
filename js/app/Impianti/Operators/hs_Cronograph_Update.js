    ...
    $(document).ready(function () {
        ...
        $('#btnUpd').on('click', function (e) {
            ...
            if (chkUpd(hsId, CronId, CronCod, CronDescr) == true) {
                var req = $.DataAccess.hs_Cron_Update(CronId, CronCod, CronDescr, NoteInterne, UserName, marcamodello, installationDate,1);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $.module.load('Impianti/Operators/Device8Cronograph');
