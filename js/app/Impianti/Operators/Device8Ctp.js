...
$(function () {
    ...
    $(document).ready(function () {
        $('.tableCtp').footable();
        $('.tableCtp').data('page-size', 30);
        $('.tableCtp').data('limit-navigation', 4);
        $('.tableCtp').trigger('footable_initialized');
        ...
        $('#btnCallAdd').on('click', function (e) {
            $.module.load('Impianti/Operators/hs_Ctp_Add');
        });
        ...
        $.fn.callUpdate = function (Id) {
            ...
            $.module.load('Impianti/Operators/hs_Ctp_Update');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.callReplacements = function (Id) {
            ...
            $.module.load('Impianti/Operators/hs_Ctp_Replacements');
        }
        /*----------------------------------------------------------------------*/
