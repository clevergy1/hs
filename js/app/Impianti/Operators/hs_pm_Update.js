...
$(function () {
    ...
    $(document).ready(function () {
        ...
        function Read() {
            var req = $.DataAccess.hs_pm_Read(localStorage.getItem("pmId"));
            req.success(function (json) {
                var data = json.d;
                if (data) {
        ...
        $('#btnUpd').on('click', function (e) {
            ...
            if (chkUpd(hsId, Id, Cod, Desc) == true) {
                var req = $.DataAccess.hs_pm_Update(Id, Cod, Desc, UserName, marcamodello, installationDate);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $.module.load('Impianti/Operators/Device8pm');
        ...
        function chkUpd(hsId, Id, Cod, Desc) {
            ...
            if (!error_present) {
                var req = $.DataAccess.hs_pm_ReadByCodSync(hsId, Cod);
                req.success(function (json) {
                    var data = json.d;
                    if (data) {
                        if (data.Id != Id) {
        ...
        $('#btnDelete').on('click', function (e) {
            ...
            setTimeout(function () {
                var req = $.DataAccess.hs_pm_Del(localStorage.getItem("pmId"));
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
