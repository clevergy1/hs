    ...
    $(document).ready(function () {
        ...
        function ReadCir() {
            ...
            req.success(function (json) {
                var data = json.d;
                if (data) {
                    $elementCode = data.CirCod;                    
                    $("#CirDesc").text(data.CirDescr);
                    loadAssignedProbes();
                    loadAssignedCronos();
                }
            });
        ...
        $.fn.seleAvailCrono = function (Id) {
            var req = $.DataAccess.hs_CirCron_Add(localStorage.getItem("CirId"), Id, localStorage.getItem("OperatorName"));
            req.success(function (json) {
                loadAssignedCronos();
                //loadAvailableProbes();
            });
        ...
        $.fn.selassignedCrono = function (Id) {
            var req = $.DataAccess.hs_CirCron_Del(Id);
            req.success(function (json) {
                loadAssignedCronos();
                //loadAvailableProbes();
            });
