...
$(function () {
    ...
    $(document).ready(function () {
        ...
        function readBoiler() {
            var req = $.DataAccess.hs_Cal_Read(localStorage.getItem("CalId"));
            req.success(function (json) {
                var data = json.d;
                if (data) {
                    $("#CalDescr").text(data.CalDescr);
                    $(".CalDescr").text(data.CalDescr);
                    readCurrentCC(data.CalCod);
                }
            });
        }

        function readCurrentCC(CalCod) {
            var req = $.DataAccess.hs_cal_currentCC_Get(localStorage.getItem("hsId"), CalCod);
            req.success(function (json) {
                var data = json.d;
                if (data) {                    
        ...
        function listCal_cc() {
            $("#ccList").empty();
            var r = $.DataAccess.hs_Cal_CC_List(localStorage.getItem("CalId"));
        ...
        $('#btnAdd').on('click', function (e) {
            ...
            if (descr == '') {
                ...
                var req = $.DataAccess.hs_Cal_CC_Add(localStorage.getItem("CalId"), descr, Tamb1, Tset1, Tamb2, Tset2, Tamb3, Tset3, Tamb4, Tset4, Tamb5, Tset5);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $('#DivEdit').hide();
        ...
        $.fn.callEdit = function (ccId) {
            var req = $.DataAccess.hs_Cal_CC_Read(ccId);
            req.success(function (json) {
                var data = json.d;
                if (data) {
                    $('#DivAdd').hide();
        ...
        $('#btnUpdate').on('click', function (e) {
            ...
            if (descr == '') {
                ...
                var req = $.DataAccess.hs_Cal_CC_Update(ccId, descr, Tamb1, Tset1, Tamb2, Tset2, Tamb3, Tset3, Tamb4, Tset4, Tamb5, Tset5);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $('#DivEdit').hide();
        ...
        $('#btnDelete').on('click', function (e) {
            var ccId = $('#ccId_Upd').val();
            var req = $.DataAccess.hs_Cal_CC_Del(ccId);
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    $('#DivEdit').hide();
        ...
        $('#bntSend').on('click', function (e) {
            ...
            var req = $.DataAccess.hs_cal_currentCC_set(localStorage.getItem("CalId"), $('#ccId_Upd').val());
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    toastr["success"](langResources['msg4operationok'], "success");
                    //leggo di nuovo la caldaia per forzare lettura climatica corrente
                    readBoiler();
                }
                else {
                    toastr["warning"](langResources['msg4operationfailed'], langResources['alert']);
