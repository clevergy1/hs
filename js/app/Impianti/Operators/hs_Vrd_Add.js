    ...
    $(document).ready(function () {
        ...
        $('#btnAdd').on('click', function (e) {
            var hsId = localStorage.getItem('hsId'),
                VrdCod = $('#VrdCod_Add').val(),
                VrdDesc = $('#Descr_Add').val(),
            ...
            if (chkAdd(hsId, VrdCod, VrdDesc) == true) {
                var req = $.DataAccess.hs_Vrd_Add(hsId, VrdCod, VrdDesc, NoteInterne, UserName, marcamodello, installationDate);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
        ...
        function chkAdd(hsId, VrdCod, VrdDesc) {
            var retVal = false;
