...
$(function () {
    ...
    $(document).ready(function () {
        ...
        function loadAssignedCronos() {
            ...
            var req = $.DataAccess.hs_CirmCron_List(localStorage.getItem("CirId"));
            req.success(function (json) {
                var data = json.d;
                if (data) {
        ...
        $.fn.seleAvailCrono = function (Id) {
            var req = $.DataAccess.hs_CirmCron_Add(localStorage.getItem("CirId"), Id, localStorage.getItem("OperatorName"));
            req.success(function (json) {
                loadAssignedCronos();
                //loadAvailableProbes();
            });
        ...
        $.fn.selassignedCrono = function (Id) {
            var req = $.DataAccess.hs_CirmCron_Del(Id);
            req.success(function (json) {
                loadAssignedCronos();
                //loadAvailableProbes();
            });
