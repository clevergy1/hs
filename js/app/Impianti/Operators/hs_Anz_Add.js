/*
Impianti Operators Manage Heating System Electric power meter Add
------------------------------------------*/
$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#btnAdd').on('click', function (e) {
            ...
            if (chkAdd(hsId, Cod, Descr) == true) {
                var req = $.DataAccess.hs_Anz_Add(hsId, Cod, Descr, UserName, marcamodello, installationDate, NoteInterne);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
