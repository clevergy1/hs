$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#btnCallAdd').on('click', function (e) {
            $.module.load('Impianti/supervisors/hs_Astr_Add');
        });
        ...
        $.fn.callUpdate = function (Id) {
            ...
            $.module.load('Impianti/supervisors/hs_Astr_Update');
        }

        $.fn.callconfig = function (Id) {
            localStorage.setItem("AstrId", Id);
            $.module.load('Impianti/supervisors/hs_Astr_Config');
        }

        $.fn.callEdit = function (Id) {
            localStorage.setItem("AstrId", Id);
            $.module.load('Impianti/supervisors/hs_Astr_Edit');
        }
        ...
        $.fn.callReplacements = function (Id) {
            ...
            $.module.load('Impianti/supervisors/hs_Astr_Replacements');
        }
        /*----------------------------------------------------------------------*/
