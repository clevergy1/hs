...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $.fn.received_cymt100_changed = function (hsId, Cod) {
            console.log("Device8Anz received_cymt100_changed hsId="+hsId + " cod="+Cod );
            if (localStorage.getItem("hsId") == hsId) {
                $('#btnrequestLog').show();
                readAnzcymt100(Cod);
            }
        ...
        function readAnzcymt100(Cod) {
            //console.log('readAnzcymt100 Cod=' + Cod + ' hsId=' + localStorage.getItem("hsId"));
            var r = $.DataAccess.cymt100_ReadByCod(localStorage.getItem("hsId"), Cod);
            r.success(function (json) {
                var data = json.d;
                if (data) {
                    //console.log('readAnzcymt100 cod=' + Cod + ' ' + moment(data.lastReceived).format("DD/MM/YYYY hh:mm"));
        ...
        $.fn.callReplacementscymt100 = function (Id) {
            ...
            $.module.load('Impianti/supervisors/cymt100_Replacements');
        }
        /*----------------------------------------------------------------------*/
