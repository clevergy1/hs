$(function () {
    ...
    $(document).ready(function () {
        ...
        function readAnzcymt200(Cod) {
            ...
            r.success(function (json) {
                ...
                if (data) {
                    ...
                    $('#Temperature_' + data.Cod).text(Number(data.Temperature).toLocaleString());
        ...
        $.fn.logAnzcymt200 = function (Cod) {
            localStorage.setItem("cymt200Cod", Cod);
            $.module.load('Impianti/supervisors/cymt200_log');
        }
        ...
        $.fn.callUpdcymt200 = function (Id) {
            ...
            $.module.load('Impianti/supervisors/cymt200_Update');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.callReplacements = function (Id) {
            ...
            $.module.load('Impianti/supervisors/cymt200_Replacements');
        }
        /*----------------------------------------------------------------------*/
