...
$(function () {
    ...
    $(document).ready(function () {
        ...
        function readGru() {
            var req = $.DataAccess.hs_Gru_Read(localStorage.getItem("GruId"));
            req.success(function (json) {
                var data = json.d;
                if (data) {
                    $("#CalDescr").text(data.CalDescr);
                    $(".CalDescr").text(data.CalDescr);
                    readCurrentCC(data.GruCod);
                }
            });
        }

        function readCurrentCC(GruCod) {
            var req = $.DataAccess.hs_Gru_currentCC_Get(localStorage.getItem("hsId"), GruCod);
            req.success(function (json) {
                var data = json.d;
                if (data) {
        ...
        function listGru_cc() {
            $("#ccList").empty();
            var r = $.DataAccess.hs_Gru_CC_List(localStorage.getItem("GruId"));
        ...
        $('#btnCallAdd').on('click', function (e) {
            $('#DivList').hide();
            $('#descr_Add').val('');            
            $('#Tamb1_Add').autoNumeric('set', 0);
            $('#Tamb2_Add').autoNumeric('set', 0);
            $('#Tamb3_Add').autoNumeric('set', 0);
            $('#Tamb4_Add').autoNumeric('set', 0);
            $('#Tamb5_Add').autoNumeric('set', 0);
            $('#Tset1_Add').autoNumeric('set', 0);
            $('#Tset2_Add').autoNumeric('set', 0);
            $('#Tset3_Add').autoNumeric('set', 0);
            $('#Tset4_Add').autoNumeric('set', 0);
            $('#Tset5_Add').autoNumeric('set', 0);
            $('#DivAdd').show();
        ...
        $('#btnAdd').on('click', function (e) {
            ...
            if (descr == '') {
                ...
                var req = $.DataAccess.hs_Gru_CC_Add(localStorage.getItem("GruId"), descr, Tamb1, Tset1, Tamb2, Tset2, Tamb3, Tset3, Tamb4, Tset4, Tamb5, Tset5);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $('#DivEdit').hide();
        ...
        $.fn.callEdit = function (ccId) {
            var req = $.DataAccess.hs_Gru_CC_Read(ccId);
            req.success(function (json) {
                var data = json.d;
                if (data) {
                    $('#DivAdd').hide();
        ...
        $('#btnUpdate').on('click', function (e) {
            ...
            if (descr == '') {
                ...
                var req = $.DataAccess.hs_Gru_CC_Update(ccId, descr, Tamb1, Tset1, Tamb2, Tset2, Tamb3, Tset3, Tamb4, Tset4, Tamb5, Tset5);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $('#DivEdit').hide();
        ...
        $('#btnDelete').on('click', function (e) {
            var ccId = $('#ccId_Upd').val();
            var req = $.DataAccess.hs_Gru_CC_Del(ccId);
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    $('#DivEdit').hide();
        ...
        $('#bntSend').on('click', function (e) {
            var req = $.DataAccess.hs_Gru_currentCC_set(localStorage.getItem("GruId"), $('#ccId_Upd').val());
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    ...
                    readGru();
                    //setTimeout(function () { readGru(); }, 5000);
                }
                else {
                    toastr["warning"](langResources['msg4operationfailed'], langResources['alert']);
                }
