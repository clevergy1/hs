    ...
    $(document).ready(function () {
        ...
        $('#btnUpd').on('click', function (e) {
            ...
            if (chkUpd(hsId, Id, Cod, Descr) == true) {
                var req = $.DataAccess.hs_Cirdm_Update(Id, Cod, Descr, UserName, marcamodello, installationDate, NoteInterne);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $.module.load('Impianti/Supervisors/Device8Cirdm');
        ...
        function chkUpd(hsId, Id, Cod, Descr) {
            ...
            if (!error_present) {
                var req = $.DataAccess.hs_Cirdm_ReadByCodSync(hsId, Cod);
                req.success(function (json) {
                    var data = json.d;
                    if (data) {
                        if (data.Id != Id) {
        ...
        $('#btnDelete').on('click', function (e) {
            ...
            setTimeout(function () {
                var req = $.DataAccess.hs_Cirdm_Del(localStorage.getItem("CirId"));
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
        ...
        function loadReplacements() {
            ...
            var r = $.DataAccess.hs_Cirdm_replacement_history_List(localStorage.getItem("CirId"));
        ...
        $('#btnAddReplacements').on('click', function () {
            var ParentId = localStorage.getItem('CirId'),
                ...
                userName = localStorage.getItem("SupervisorName");
            var req = $.DataAccess.hs_Cirdm_replacement_history_Add(ParentId, marcamodello, installationDate, note, userName);
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    loadReplacements();
        ...
        $.fn.CallEdit = function (Id) {
            ...
            var req = $.DataAccess.hs_Cirdm_replacement_history_Read(Id);
            req.success(function (json) {
                var data = json.d;
                if (data) {
                    $('#Id_Upd').val(data.Id);
        ...
        $('#btnUpdReplacement').on('click', function () {
            ...
            note = $('#note_Upd').val(),
            userName = localStorage.getItem("SupervisorName");
            var req = $.DataAccess.hs_Cirdm_replacement_history_Update(Id, marcamodello, installationDate, note, userName);
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    loadReplacements();
        ...
        $('#btnDeleteReplacements').on('click', function () {
            var Id = $('#Id_Upd').val();
            var req = $.DataAccess.hs_Cirdm_replacement_history_Del(Id);
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    loadReplacements();
