$(function () {
    ...
    $(document).ready(function () {
        ...
        function Readhvac() {
            var req = $.DataAccess.hs_hvac_ReadByCod(localStorage.getItem("hsId"), localStorage.getItem("Cod"));
            req.success(function (json) {
                var data = json.d;
                if (data) {
        ...
        var $logRowNumber = 0;
        function loadLog() {
            var r = $.DataAccess.log_hs_hvac_ListPaged(localStorage.getItem("hsId"), localStorage.getItem("Cod"), $('#datefrom').val(), $('#dateto').val(), $logRowNumber);
