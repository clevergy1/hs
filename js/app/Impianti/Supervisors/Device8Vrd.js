    ...
    $(document).ready(function () {
        ...
        $.fn.received_hs_Vrd_setStatus = function (hsId, VrdCod, SetPoint, SetPosition, Position, stato) {
            if (localStorage.getItem("hsId") == hsId) {
                ...
                $('#SetPoint_' + VrdCod).text(SetPoint + '°C');
        ...
        $('#btnCallAddVrd').on('click', function (e) {
            $.module.load('Impianti/supervisors/hs_Vrd_Add');
        });
        ...
        $.fn.callUpdateVrd = function (VrdId) {
            ...
            $.module.load('Impianti/supervisors/hs_Vrd_Update');
        }

        $.fn.callEditVrd = function (VrdId) {
            localStorage.setItem("VrdId", VrdId);
            $.module.load('Impianti/Supervisors/hs_Vrd_CC');
        }

        $.fn.callconfigVrd = function (VrdId) {
            localStorage.setItem("VrdId", VrdId);
            $.module.load('Impianti/supervisors/hs_Vrd_Config');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.callReplacements = function (Id) {
            ...
            $.module.load('Impianti/supervisors/hs_Vrd_Replacements');
        }
        /*----------------------------------------------------------------------*/
