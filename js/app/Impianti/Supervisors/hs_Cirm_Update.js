$(function () {
    ...
    $(document).ready(function () {
        ...
        function ReadCir() {
            var req = $.DataAccess.hs_Cirm_Read(localStorage.getItem("CirId"));
            req.success(function (json) {
                var data = json.d;
                if (data) {
        ...
        $('#btnUpd').on('click', function (e) {
            ...
            if (chkUpd(hsId, Id, Cod, Descr) == true) {
                var req = $.DataAccess.hs_Cirm_Update(Id, Cod, Descr, UserName, marcamodello, installationDate, NoteInterne);
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
                        $.module.load('Impianti/supervisors/Device8Cirm');
        ...
        function chkUpd(hsId, Id, Cod, Descr) {
            ...
            if (!error_present) {
                var req = $.DataAccess.hs_Cirm_ReadByCodSync(hsId, Cod);
                req.success(function (json) {
                    var data = json.d;
                    if (data) {
                        if (data.Id != Id) {
        ...
        $('#btnDelete').on('click', function (e) {
            ...
            setTimeout(function () {
                var req = $.DataAccess.hs_Cirm_Del(localStorage.getItem("CirId"));
                req.success(function (json) {
                    var data = json.d;
                    if (data == true) {
