...
$(function () {
    ...
    $(document).ready(function () {
        ...
        function ReadE() {
            var req = $.DataAccess.cymt200_Read(localStorage.getItem("ParentId"));
            req.success(function (json) {
                var data = json.d;
                if (data) {
                    console.log('installationDate', moment(data.installationDate).year());
        ...
        function loadReplacements() {            
            ...
            var r = $.DataAccess.cymt200_replacement_history_List(localStorage.getItem("ParentId"));
        ...
        $('#btnUpdParent').on('click', function () {
            var marcamodello = $('#marcamodello_UpdParent').val(),
                ...
                userName = localStorage.getItem("SupervisorName");
            var req = $.DataAccess.cymt200_UpdateMarcamodello(localStorage.getItem("ParentId"), marcamodello, installationDate, userName);
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    $('#parentRecord').show();
