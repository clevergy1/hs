$(function () {
    ...
    $(document).ready(function () {
        ...
        function loadCron() {
            $tabledata = [];
            if (localStorage.getItem("CronOnOff") == 0) {
        ...
        $.fn.go2PrevElement = function () {
            var ele2Go = 0;
            var currentId = localStorage.getItem("CronId");
            for (var i = 0; i < $tabledata.length; i++) {
                if ($tabledata[i].CronId == currentId) {
                    if (i > 0) {
                        ele2Go = $tabledata[i - 1].CronId;                        
                    }
                }
            }
            ...
            localStorage.setItem("CronId", ele2Go);
        ...
        $.fn.go2NextElement = function () {
            ...
            if (ele2Go == 0) {
                ele2Go = $tabledata[$tabledata.lengt].CronId;
            }
            localStorage.setItem("CronId", ele2Go);
        ...
        $('#bntRestoreTask').on('click', function () {
            ...
            var currYear = moment(date).year();
            var currMonth = moment(date).month() + 1;
            var req = $.DataAccess.hs_Cron_Calendar_replaceDesiredWithTask(CronId, currYear, currMonth);
            req.success(function (json) {
                var data = json.d;
                if (data == true) {
                    events = [];
       ...
       // var editGraphData = []
        ...
        $.fn.CallEditProfile = function (ProfileNr) {
            ...
            var currYear = moment(date).year();
            var currMonth = moment(date).month() + 1;
            readProfile(localStorage.getItem("CronId"), currYear, ProfileNr);
        }
        ...
        function readProfile(CronId, ProfileY, ProfileNr) {
            console.log('readProfile', CronId, ProfileY, ProfileNr);
            editGraphData = [];
            ProfileData = [];
        ...
        $('#btnGetProfile').on('click', function () {
            ...
            $("body").addClass("loading");
            var r = $.DataAccess.hs_cron_Profile_get(localStorage.getItem("hsId"), $CronCod, currYear, $ProfileNr);
            r.success(function (json) {
                var data = json.d;
                if (data) {
        ...
        $('#btnUpdProfile').on('click', function () {
            ...
            var r = $.DataAccess.hs_cron_Profile_set(localStorage.getItem("hsId"), $CronCod, currYear, $ProfileNr, strProfiledata);
            r.success(function (json) {
                var data = json.d;
                if (data == true) {
                    ...
                    getProfile(localStorage.getItem("hsId"), $CronCod, currYear, $ProfileNr);
                    $("body").removeClass("loading");
        ...
        function loadProfiles4Copy(CronId, CronCod) {
            ...
            if ($hsIdOnLine == true) {
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 0);
                r.success(function (json) {
                    var data = json.d;
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 1);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 2);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 3);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 4);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 5);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 6);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 7);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 8);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 9);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
                ...
                var r = $.DataAccess.hs_cron_Profile_ReadSync(CronId, currYear, 10);
                r.success(function (json) {
                    var data = json.d;
                    if (data) { populateTable4Copy(data); }
