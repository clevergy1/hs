...
$(function () {
    ...
    $(document).ready(function () {       
            ...
            if (localStorage.getItem("hsId") == hsId) {
                ...
                req.success(function (json) {
                    ...
                    if (data) {
                        ...
                        var objName = data.CalCod + '_STATUS';
                        var obj = document.getElementById(objName);
                        if (obj) {
                            if (stato == 0) {
                                obj.style.fill = $verde;
        ...
        $.fn.callEditGru = function (GruId) {
            ...
            $('#synoptic').hide();
            $.module.load('Impianti/Operators/hs_Gru_CC');
            $('#detail').show();
        }
        /*-----------------------------------------------------------------------*/
        ...
        $.fn.CallChangeCirCurrentProfile = function (CirId) {
            ...
            $.module.load('synoptic/Operators/ChangeCirCurrentProfile');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.CallChangeCirdCurrentProfile = function (CirId) {
            localStorage.setItem("CirId", CirId);
            $.module.load('synoptic/Operators/ChangeCirdCurrentProfile');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.CallChangeCirmCurrentProfile = function (CirId) {
            localStorage.setItem("CirId", CirId);
            $.module.load('synoptic/Operators/ChangeCirmCurrentProfile');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.CallChangeCirdmCurrentProfile = function (CirId) {
            localStorage.setItem("CirId", CirId);
            $.module.load('synoptic/Operators/ChangeCirdmCurrentProfile');
        }
        /*----------------------------------------------------------------------*/
        ...
        $.fn.callEditAnz = function (AnzId) {
            ...
            $('#detail').show();
            $('#synoptic').hide();
            $.module.load('Impianti/Operators/Device8Anz');
        }
        /*----------------------------------------------------------------------*/
       ...
       ------------------------------------------------------------------------*/
        ...
        $.fn.btnCloseDetail = function () {
            ...
            $('#usermenu').empty();
            $('#bit_box').hide();
            $.module.load('Impianti/Operators/hs_Synoptic.html');
           
        }


        $('#back2backoffice').on('click', function () {
            var whereigo = 'Operators/main.html';
        ...
        $('#documents').on('click', function () {
            $('#detail').show();
            $('#synoptic').hide();
            $.module.load('Impianti/Operators/hs_doc_manage.html');
